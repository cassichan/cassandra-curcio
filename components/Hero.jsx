      ...
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <p className="mb-8 leading-relaxed font-medium text-gray-300">
           Software Engineer with a background in Healthcare and Project Management.
           <br className="hidden lg:inline-block" />
           In love with solving meaningful problems with code!
          </p>
          <div className="flex justify-center">
            <a href="https://docs.google.com/document/d/15GM5uc_WCekFqrclNi2-AW8xl1Y2qdjvGTno2DbRWsw/edit?usp=sharing" target="_blank" rel="noopener noreferrer">
